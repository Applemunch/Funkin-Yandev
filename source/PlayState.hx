...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'dev':
				dialogue = CoolUtil.coolTextFile('assets/data/dev/devDialogue.txt');
			case 'drama':
				dialogue = CoolUtil.coolTextFile('assets/data/drama/dramaDialogue.txt');
			case 'blades':
				dialogue = CoolUtil.coolTextFile('assets/data/blades/bladesDialogue.txt');
		}
		...
		else if (SONG.song.toLowerCase() == 'dev' || SONG.song.toLowerCase() == 'drama')
		{
			curStage = 'school';
		...
		else if (SONG.song.toLowerCase() == 'blades')
		{
			curStage = 'schoolEvil';
	...
	function schoolIntro(?dialogueBox:DialogueBox):Void
	{
		...
		if (SONG.song.toLowerCase() == 'drama' || SONG.song.toLowerCase() == 'blades')
		{
			remove(black);

			if (SONG.song.toLowerCase() == 'blades')
			{
				add(red);
			}
		}
